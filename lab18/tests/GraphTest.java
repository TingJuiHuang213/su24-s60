...
public class GraphTest {
    ...
    // Helper method to create a graph with directed edges
    ...
    // Helper method to create a graph with undirected edges
    private Graph createUndirectedGraph() {
        ...
        g.addUndirectedEdge(3, 2, 6);
        g.addUndirectedEdge(4, 1, 3);
        g.addUndirectedEdge(4, 2, 9);
    ...
    @Test
    public void testShortestPathInUndirectedGraph() {
